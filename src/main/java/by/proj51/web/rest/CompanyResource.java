...
/**
 * REST controller for managing {@link by.proj51.domain.Company}.
 */
@RestController
@RequestMapping("/api")
public class CompanyResource {
    ...
    public ResponseEntity<CompanyDTO> updateCompany(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, companyDTO.getId()))
            .body(result);
    }
