...
public class MoneyRecipientResource {
    ...
    public ResponseEntity<MoneyRecipient> updateMoneyRecipient(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, moneyRecipient.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<MoneyRecipient> partialUpdateMoneyRecipient(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, moneyRecipient.getId().toString())
        );
    }
    ...
    public ResponseEntity<MoneyRecipient> getMoneyRecipient(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> deleteMoneyRecipient(@PathVariable Long id) {
