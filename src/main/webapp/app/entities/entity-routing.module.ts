...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'fitness-account',
        data: { pageTitle: 'donorunApp.fitnessAccount.home.title' },
        loadChildren: () => import('./fitness-account/fitness-account.module').then(m => m.FitnessAccountModule),
      },
