...
describe('Company Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const employees: IUser[] = [{ id: 'a3662817-6678-4ad7-8796-78da7407d8f4' }];
      company.employees = employees;

      const userCollection: IUser[] = [{ id: '6770494b-ca2d-4f49-93e8-4b17eccde99e' }];
      jest.spyOn(userService, 'query').mockReturnValue(of(new HttpResponse({ body: userCollection })));
      const additionalUsers = [...employees];
    ...
    it('Should update editForm', () => {
      const company: ICompany = { id: 'CBA' };
      const employees: IUser = { id: '92606bcf-d285-48a6-ba99-565df92ec458' };
      company.employees = [employees];
      ...
      expect(comp.usersSharedCollection).toContain(employees);
    });
  });
