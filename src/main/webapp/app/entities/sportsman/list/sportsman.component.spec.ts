...
describe('Sportsman Management Component', () => {
  let comp: SportsmanComponent;
  let fixture: ComponentFixture<SportsmanComponent>;
  let service: SportsmanService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'sportsman', component: SportsmanComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SportsmanComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sportsmen?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
