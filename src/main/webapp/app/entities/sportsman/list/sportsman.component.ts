...
export class SportsmanComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.sportsmanService
      ...
      .subscribe({
        next: (res: HttpResponse<ISportsman[]>) => {
  ...
  trackId(_index: number, item: ISportsman): string {
    return item.id!;
  }

  delete(sportsman: ISportsman): void {
    const modalRef = this.modalService.open(SportsmanDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.sportsman = sportsman;
  ...
  protected onSuccess(data: ISportsman[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
