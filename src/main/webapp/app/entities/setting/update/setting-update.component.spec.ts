...
describe('Setting Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Company query and add missing value', () => {
      ...
      const company: ICompany = { id: 'd09796d8-7a22-449a-be8f-00aaedd16ab1' };
      setting.company = company;

      const companyCollection: ICompany[] = [{ id: '2bf3cf5d-e311-46bb-8f6e-976b0b0d7b68' }];
    ...
    it('Should update editForm', () => {
      const setting: ISetting = { id: 'CBA' };
      const company: ICompany = { id: 'ec1d8440-22e5-4e43-af64-c0f9bcd24276' };
      setting.company = company;
