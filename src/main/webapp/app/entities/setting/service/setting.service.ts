...
export class SettingService {
  ...
  update(setting: ISetting): Observable<EntityResponseType> {
    return this.http.put<ISetting>(`${this.resourceUrl}/${getSettingIdentifier(setting) as string}`, setting, { observe: 'response' });
  }

  partialUpdate(setting: ISetting): Observable<EntityResponseType> {
    return this.http.patch<ISetting>(`${this.resourceUrl}/${getSettingIdentifier(setting) as string}`, setting, { observe: 'response' });
  }
