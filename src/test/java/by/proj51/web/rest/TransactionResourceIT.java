...
class TransactionResourceIT {
    ...
    private static final Double DEFAULT_SUM_OF_MONEY = 1D;
    private static final Double UPDATED_SUM_OF_MONEY = 2D;
    ...
    public static Transaction createEntity() {
        Transaction transaction = new Transaction()
            .sumOfMoney(DEFAULT_SUM_OF_MONEY)
    ...
    public static Transaction createUpdatedEntity() {
        Transaction transaction = new Transaction()
            .sumOfMoney(UPDATED_SUM_OF_MONEY)
    ...
    void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getSumOfMoney()).isEqualTo(DEFAULT_SUM_OF_MONEY);
        assertThat(testTransaction.getMessage()).isEqualTo(DEFAULT_MESSAGE);
        assertThat(testTransaction.getWasPaid()).isEqualTo(DEFAULT_WAS_PAID);
        assertThat(testTransaction.getDateOfPayment()).isEqualTo(DEFAULT_DATE_OF_PAYMENT);
    ...
    void getAllTransactions() throws Exception {
        ...
        restTransactionMockMvc
            ...
            .andExpect(jsonPath("$.[*].sumOfMoney").value(hasItem(DEFAULT_SUM_OF_MONEY.doubleValue())))
    ...
    void getTransaction() throws Exception {
        ...
        restTransactionMockMvc
            ...
            .andExpect(jsonPath("$.sumOfMoney").value(DEFAULT_SUM_OF_MONEY.doubleValue()))
    ...
    void putNewTransaction() throws Exception {
        ...
        Transaction testTransaction = transactionList.get(transactionList.size() - 1);
        assertThat(testTransaction.getSumOfMoney()).isEqualTo(UPDATED_SUM_OF_MONEY);
        assertThat(testTransaction.getMessage()).isEqualTo(UPDATED_MESSAGE);
        assertThat(testTransaction.getWasPaid()).isEqualTo(UPDATED_WAS_PAID);
        assertThat(testTransaction.getDateOfPayment()).isEqualTo(UPDATED_DATE_OF_PAYMENT);
