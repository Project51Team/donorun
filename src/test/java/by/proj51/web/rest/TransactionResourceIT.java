...
class TransactionResourceIT {
    ...
    public static Transaction createEntity() {
        Transaction transaction = new Transaction().amountOfMoney(DEFAULT_AMOUNT_OF_MONEY).createdDate(DEFAULT_CREATED_DATE);
        return transaction;
    }
    ...
    public static Transaction createUpdatedEntity() {
        Transaction transaction = new Transaction().amountOfMoney(UPDATED_AMOUNT_OF_MONEY).createdDate(UPDATED_CREATED_DATE);
        return transaction;
    }
    ...
    void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getAmountOfMoney()).isEqualTo(DEFAULT_AMOUNT_OF_MONEY);
    ...
    void putNewTransaction() throws Exception {
        ...
        updatedTransaction.amountOfMoney(UPDATED_AMOUNT_OF_MONEY).createdDate(UPDATED_CREATED_DATE);
        ...
        Transaction testTransaction = transactionList.get(transactionList.size() - 1);
        assertThat(testTransaction.getAmountOfMoney()).isEqualTo(UPDATED_AMOUNT_OF_MONEY);
    ...
    void partialUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.createdDate(UPDATED_CREATED_DATE);
    ...
    void fullUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.amountOfMoney(UPDATED_AMOUNT_OF_MONEY).createdDate(UPDATED_CREATED_DATE);
